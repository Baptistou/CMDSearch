...
ECHO ParamŠtres : %FPARAM% %-B% %-C% %-E% %-I% %-L% %-M% /N:%NBCHAR% %-P% %-Q:/P=/Q% %-R% %-S% %-X%
ECHO.
ECHO R‚sultat de la recherche :
:next2
SET /A N=0
...
IF %COMP_TYPE%==FILE ECHO ParamŠtres : %-A% %-B% %-I:/C=/I% %-R%
IF %COMP_TYPE%==DIR ECHO ParamŠtres : /NAME %NAME% /DATE %DATE1%-%DATE2% /TIME %TIME1%-%TIME2% %ATTR% %-S% %-T% %-V%
ECHO.
ECHO R‚sultat de la recherche :
:next3
...
ECHO.
IF "%~1"=="" GOTO HELP_EXIT
ECHO  Les variables suivantes peuvent ˆtre utilis‚es dans la chaŒne de commandes :
...
ECHO  Supprime tous les fichiers contenant la chaŒne "Hello world".
ECHO.
ECHO  SEARCH COMP test1 test2 /V /CMD "echo @fname"
ECHO  Recherche tous les fichiers homonymes des r‚pertoires "test1" et "test2".
ECHO.
